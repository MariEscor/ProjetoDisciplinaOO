...
from menu_manager import resetar_player_state
...
class PauseMenu:
    ...
    def execute_option(self):
        ...
        if option == "Continuar":
            ...
            self._menu_manager.options_menu()
        elif option == "Menu":
            self._save_manager.save_progress()  # Salva progresso antes de voltar ao menu
            resetar_player_state()
            self.jogo.running = False  # sinaliza para o loop principal parar e voltar ao menu
        elif option == "Sair":
            self._save_manager.save_progress()  # Salva progresso antes de sair do jogo
            pygame.quit()
            exit()
