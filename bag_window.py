...
from bag_manager import load_bag
from bag_manager import select_pokemon_for_battle, deselect_pokemon
from bag_manager import save_bag
...
class BagWindow:
    ...
    def handle_event(self, event):
        if event.type == pygame.MOUSEBUTTONDOWN and event.button == 1:
            ...
            if self.botao_esquerda.collidepoint(mouse_pos):
                ...
                SOM_CLIQUE.play()
                max_pag = max(0, (len(load_bag().get("pokemons", [])) - 1) // self.pokemons_por_pagina)
    ...
    def _toggle_selection(self, idx):
        ...
        if pokemon in self.selecionados:
            ...
            select_pokemon_for_battle(nome)
